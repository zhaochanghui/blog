                            ...
                            <header class="entry-header">
                                ...
                                <div class="entry-meta">
                                    <span class="posted-on"><a href=""><time class="entry-date published"
                                                                             datetime="2018-08-24"><fmt:formatDate value="${item.updateTime}"  pattern="yyyy-MM-dd HH:mm:ss"/> </time><time
                    ...
                    <nav>
                        <ul class="pagination">
                            <c:forEach var="p" items="${page.navigatepageNums}">
                                <li  <c:if test="${page.pageNum==p}"> class="active"  </c:if>><a class="btn-more" href="<%=request.getContextPath()%>/home/article_search?pageNum=${p}&search=${search}" class='page'>${p }</a></li>
                            </c:forEach>
                        </ul>
                    </nav>
